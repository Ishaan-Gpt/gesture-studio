...
const transformations = [
    {
        ...
        icon: Hand,
        before: {
            title: "Friction-Based UI",
            points: ["Physical contact required", "Restrictive navigation", "Input device dependency"],
        },
        after: {
            title: "Neural Interaction",
            points: ["Zero-touch commands", "Infinite freedom", "Universal accessibility"],
        },
    ...
    },
    {
        ...
        icon: Box,
        before: {
            title: "Static 2D Viewers",
            points: ["Limited perspectives", "Zero depth", "Passive browsing"],
        },
        after: {
            title: "Immersive 3D Assets",
            points: ["Tactile 360° control", "Realistic physics", "Deep engagement"],
        },
    ...
    },
    {
        ...
        before: {
            ...
            points: ["Manual clicking loops", "Linear navigation", "Standard interactions"],
        },
        after: {
            title: "Gesture Excellence",
            points: ["Natural human input", "Touchless shortcuts", "Premium interaction"],
        },
    ...
    },
    {
        ...
        before: {
            ...
            points: ["Flat components", "Low retention rates", "Forgettable UX"],
        },
        after: {
            title: "Next-Gen Identity",
            points: ["State-of-the-art tech", "Awwwards-level fidelity", "Memorable brand story"],
        },
    ...
    },
    {
        ...
        before: {
            ...
            points: ["High bounce rates", "Slow product discovery", "Low confidence"],
        },
        after: {
            title: "Active Interaction",
            points: ["Reduced friction", "Playful exploration", "Increased sales velocity"],
        },
    ...
    },
    {
        ...
        before: {
            title: "Legacy Cycles",
            points: ["Weeks of development", "Unpredictable results", "Slow launch speed"],
        },
        after: {
            title: "Elite Turnaround",
            points: ["96-hour prototyping", "Battle-tested code", "Rapid market entry"],
        },
