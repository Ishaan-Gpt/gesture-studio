...
const services = [
    {
        ...
        subtitle: 'The Web Redefined',
        description: 'Elite hand-tracking engines integrated into your existing platforms. Zero hardware. Just high-performance AI precision.',
        features: [
            'Proprietary Neural Engine',
            'Zero-Latency Response',
            'Cross-Browser Unity',
            'Webcam-Only Deployment',
            'Custom Gesture Schematics',
        ],
    },
    {
        id: 2,
        ...
        subtitle: 'Concept Engineering',
        description: 'We turn your wildest interaction concepts into tangible digital reality. Bespoke design meets industry-leading math.',
        features: [
            'Interaction Blueprints',
            'Brand-Synced Esthetics',
    ...
    },
    {
        ...
        description: 'Transform your existing 3D assets into interactive canvases. We bridge the gap between static content and living interfaces.',
        features: [
            '3D Model Optimization',
            'Kinetic Asset Control',
            'Impact-First Design',
            'Real-time Rendering',
    ...
    },
    {
        ...
        description: 'Upgrade your current user experience without a total rebuild. We layer in gesture controls for immediate brand elevation.',
        features: [
